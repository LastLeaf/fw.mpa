...
exports.route = function(app, express, cb){
	...
	app.get('*', function(req, res){
		if(app.debug && req.path === '/~fw/routes.js') {
			...
			// loading logo
			res.sendFile(app.config.path.rc + '/' + app.config.client.loadingLogo, {root: process.cwd()});
		} else if(app.debug && req.path === '/~fw/'+app.config.client.favicon) {
			// loading logo
			res.sendFile(app.config.path.rc + '/' + app.config.client.favicon, {root: process.cwd()});
